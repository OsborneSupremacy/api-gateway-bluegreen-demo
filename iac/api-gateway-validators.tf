...
# Since there are only 3 combinations of request body and parameters validation,
# we can create a validator for each combination at the API level and then allow each integration to specify which one to use.
